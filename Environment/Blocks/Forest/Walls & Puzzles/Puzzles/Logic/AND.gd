...
func _ready():
	if input_obj1 && input_obj2:
		input_obj1.connect("on", Callable(self, "on_trigger_on1"))
		input_obj1.connect("off", Callable(self, "on_trigger_off2"))
		input_obj2.connect("on", Callable(self, "on_trigger_on1"))
		input_obj2.connect("off", Callable(self, "on_trigger_off2"))
